            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('authasprak/registration'); ?>">
                        ...
                        <hr>
                        <div class="text-center">
                            <a class="small" href="<?= base_url('authasprak/forgotpassword') ?>">Forgot Password?</a>
                        </div>
                        <div class="text-center">
                            <a class="small" href="<?= base_url(); ?>authasprak">Already have an account? Login!</a>
                        </div>
                    </div>
                </div>
            </div>
